    ...
    <div className="shadow-2xl px-[14px] py-4 rounded-lg flex flex-col bg-white mt-3 sm:flex-row">
      <div className="flex flex-row justify-between ">
        <div className="flex flex-col gap-4 ml-1 sm:flex-row">
          <div>
            <p className=" text-[20px] text-gray-700 font-semibold">{project.name}</p>
            <p className="text-gray-500">{formattedStartDate} to {formattedEndDate}</p>
          </div>
          <div className="flex flex-col gap-1 sm:flex-row">
            <p className="text-md">
              <span className="text-gray-700">Reason: </span>{project.reason}
            </p>
            <div className="flex justify-center  gap-3">
              ...
              <p className="text-md">
                <span className="text-gray-500">Div: </span>{project.division}
              </p>
              <p className="text-md">
                <span className="text-gray-500">Dept: </span>{project.department}
              </p>
              </div>
              <p className="text-md">
              ...
              <p className="text-md">
                <span className="text-gray-500">Priority: </span>{project.priority}
              </p>
